    ...
    <header className="relative min-h-[85vh] flex items-center justify-center pt-20 pb-32 overflow-hidden border-b border-border-subtle bg-black">
      ...
      <div className="relative z-10 px-6 md:px-16 max-w-4xl mx-auto w-full text-center space-y-8">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface border border-border-subtle rounded-full justify-center reveal-left">
          ...
          <h1 className="font-headline text-5xl md:text-6.5xl font-extrabold text-white leading-tight reveal-left">
            Expertos en <span className="text-success-neon block mt-1">Soporte Técnico y Automatización con IA</span>
          </h1>

          <p className="text-terminal-gray text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-sans reveal-right">
