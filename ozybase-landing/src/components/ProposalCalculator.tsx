  ...
  return (
    <section className="py-24 bg-black border-t border-border-subtle" id="cotizador">
      <div className="max-w-[1280px] mx-auto px-6 md:px-16">
        {showSuccessModal ? (
          <div className="max-w-xl mx-auto bg-[#141414] border border-border-subtle rounded-2xl p-8 md:p-12 relative shadow-2xl flex flex-col justify-between min-h-[500px] w-full animate-[fadeIn_0.3s_ease-out]">
            ...
            <div className="my-auto text-center space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="font-headline text-3xl font-bold text-white tracking-wide uppercase">
                  Solicitud Recibida
                </h3>
              ...
              <div className="space-y-4 pt-4 max-w-xs mx-auto w-full">
                <button
                  onClick={() => setShowSuccessModal(false)}
                  className="w-full py-3.5 border border-border-subtle text-white hover:border-[#D2F20B] hover:text-[#D2F20B] rounded-lg text-xs font-mono font-bold transition-all uppercase tracking-wider"
                >
                ...
                {!hasDownloadedPDF && (
                  <button
                    onClick={handlePrint}
                    className="w-full py-3.5 bg-success-neon/10 hover:bg-[#D2F20B] text-success-neon hover:text-black border border-success-neon/30 hover:border-success-neon rounded-lg text-xs font-mono font-bold transition-all uppercase tracking-wider flex items-center justify-center gap-2"
                  >
            ...
            <div className="flex justify-between items-end border-t border-white/5 pt-4 font-mono text-[9px] text-terminal-gray/60 mt-12">
